  ...
  experience: {
    ...
    jobs: [
      ...
      },
      {
        ...
        location: 'Brésil',
        description: [
          'Développé une station de test automatique portable pour les composants de machines synchrones',
          'Aidé à inspecter, réparer et documenter les relais de protection et les variateurs de fréquence',
          'Inspecté, réparé et documenté les bancs de batteries et équipements électroniques des laboratoires',
          'Aidé à inspecter, réparer et documenter les contrôleurs de machines synchrones',
          'Élaboré divers rapports et procédures de gestion',
        ],
      },
    ],
  },
